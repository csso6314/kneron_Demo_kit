...
const char* GIT_CMD = "git log -1 --abbrev=8 --pretty=format:0x%h > git_id.txt 2>/dev/null";
/* NCPU's KSRS ID creates by DFU program */
/* SCPU's KSRS_ID created by SCPU pre_build.bat */
const char* KSRS_ID_FILE = "ksrs_id.txt";
const char* KSRS_CMD = "KSR_server_handler.exe -r 1 --skip_id_print 1 2>/dev/null";
